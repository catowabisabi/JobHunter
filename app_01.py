...
def submit_job():
    try:
        ...
        try:
            ...
            cv_html_content = markdown2.markdown(cv_md, extras=[
                "tables",
                "break-on-newline",
                "cuddled-lists",
                "fenced-code-blocks",
            ...
            cover_letter_en_html_content = markdown2.markdown(cover_letter_md, extras=[
                "tables",
                "break-on-newline",
                "cuddled-lists",
                "fenced-code-blocks",
            ...
            cover_letter_zh_html_content = markdown2.markdown(chinese_cover_letter_md, extras=[
                "tables",
                "break-on-newline",
                "cuddled-lists",
                "fenced-code-blocks",
